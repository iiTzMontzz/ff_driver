...
class FrontCarView extends StatefulWidget {
  @override
  _FrontCarViewState createState() => _FrontCarViewState();
}

class _FrontCarViewState extends State<FrontCarView> {
  String imageUrl;
  @override
